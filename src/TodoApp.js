...
const GET_TASKS_API_BASE_URL = 'http://get-task.cptiwari.cloud';
const DELETE_TASK_API_BASE_URL = 'http://delete-task.cptiwari.cloud';
const CREATE_TASK_API_BASE_URL = 'http://add-task.cptiwari.cloud';
